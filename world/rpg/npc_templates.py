...
# Combat: unarmed, short_blades, long_blades, blunt_weaponry, sidearms, longarms, automatics, evasion, stealth
COMBAT_SKILLS = ["unarmed", "short_blades", "long_blades", "blunt_weaponry", "sidearms", "longarms", "automatics", "evasion", "stealth"]
